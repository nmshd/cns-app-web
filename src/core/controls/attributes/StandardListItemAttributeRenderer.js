...
sap.ui.define(
    ...
    function (coreLibrary, Core, Renderer, IconPool, ListItemBaseRenderer) {
        "use strict"
        ...
        StandardListItemRenderer.renderTitleWrapper = function (rm, oLI) {
            ...
            const valueControl = oLI.getAggregation("_value")
            if (valueControl) {
                rm.openStart("div").class("attributeRendererValue")
                rm.openEnd()
                rm.renderControl(valueControl)
                rm.close("div")
            }
        ...
        StandardListItemRenderer.renderExpandCollapse = function (rm, oLI, sWrapArea) {
            ...
            rm.openStart("span", bTitle ? sId + "-titleButton" : sId + "-descriptionButton").class(
        ...
        StandardListItemRenderer.renderWrapping = function (rm, oLI, sWrapArea) {
            ...
            rm.openStart("span", sId + "-" + sWrapArea + "Text")
