    ...
    (
        ...
        return AccountController.extend("nmshd.app.flows.account.relationships.Template", {
            ...
            async onRouteMatched(oEvent) {
                ...
                this.templateId = oEvent.getParameter("arguments").templateId
            ...
            async checkTemplate() {
                ...
                if (identity.relationship.status === "Active") {
                    try {
                        this.navTo("account.relationship.home", {
                    ...
                    this.navTo("account.outgoingrequest", {
                        accountId: this.accountId,
                    ...
                    this.navTo("account.incomingrequest", {
                        accountId: this.accountId,
                        relationshipId: identity.relationship.id
                    })
                    return false
