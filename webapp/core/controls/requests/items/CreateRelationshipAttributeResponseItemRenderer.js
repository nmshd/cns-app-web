        ...
        return Control.extend(
            "nmshd.app.core.controls.requests.items.CreateRelationshipAttributeResponseItemRenderer",
            {
                ...
                init(e) {
                    ...
                    this.setAggregation(
                        ...
                        new Label({ text: { path: "name", formatter: Formatter.toTranslated } })
                            .addStyleClass("createRelationshipAttributeResponseItemRendererLabel")
                    ...
                    this.setAggregation(
                        ...
                        new AttributeRenderer({
                            ...
                            .addStyleClass("createRelationshipAttributeResponseItemRendererFoundAttribute")
                ...
                renderer(oRM, oControl) {
                    ...
                    oRM.addClass("createRelationshipAttributeResponseItemRenderer")
                    oRM.writeClasses()
                    oRM.write(">")
