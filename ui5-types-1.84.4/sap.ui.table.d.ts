  ...
  namespace ui {
    ...
    namespace table {
      ...
      interface $RowSettingsSettings extends sap.ui.core.$ElementSettings {
         ...
         *
         * If set to `true`, a navigation indicator is displayed at the end of the row. **Note:** The navigation
         * indicator is only visible if row actions are available.
         */
        navigated?: boolean;
      }
      ...
      interface $TableSettings extends sap.ui.core.$ControlSettings {
         ...
         * of the columns in the {@link sap.ui.table.Table#setColumns columns} aggregation of the table. The actions
